...
def control_to_goal(Single_robot, path, bot0_status: object):
    if path[0][0]==0:
        ...
        # print("bot_status:",bot0_status, file=sys.stderr)
        ...
        if abs(err) > math.pi/18:
            robot_control("forward", Single_robot.id-1, 0.15)
            ...
            robot_control("rotate",Single_robot.id-1,4/r)    
        ...
        #         robot_control("forward", Single_robot.id - 1, 3)
        #     else:
